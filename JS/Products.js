...
var proArr = [
  ...
  {
    Image:
      "https://cdn.shopify.com/s/files/1/0399/1728/9633/products/image-36_1024x.png?v=1590836878",
    Name: "Guggul",
    Price: "15.95",
    des: "Helps eliminate waste and relieves occasional bloating. Restores regularity by supporting digestive metabolism. Doesn’t rely on harsh detox herbs or fad diet ingredients. Clinically studied for comfortable, cleansing bowel movements....",
    quant: "1",
  ...
  {
    Image:
      "https://cdn.shopify.com/s/files/1/0399/1728/9633/products/ImmunoCare-120---Box-Bottle_1024x.png?v=1595814320",
    Name: "ImmunoCare®",
    Price: "23.95",
    des: "Helps eliminate waste and relieves occasional bloating. Restores regularity by supporting digestive metabolism. Doesn’t rely on harsh detox herbs or fad diet ingredients. Clinically studied for comfortable, cleansing bowel movements....",
    quant: "1",
...
function AddToCart(element) {
  ...
  Array.from(itemsInCart)[0].innerHTML =
    "There are " + store.length + " items in your Cart";
  ...
  var popUpTotal = document.getElementsByClassName("popProductPrice");
  Array.from(popUpTotal)[0].innerHTML =
    store[store.length - 1].quant + " x " + "$" + store[store.length - 1].Price;
  // popupDiv
...
function getSelectValue() {
  ...
  if (selectedfilter.value === "PriceAscending") {
    ...
    var filterArr2 = proArr.sort((a, b) =>
      a.Name > b.Name ? 1 : b.Name > a.Name ? -1 : 0
    );
    showprod(filterArr2);
  } else if (selectedfilter.value === "NameDescending") {
    var filterArr3 = proArr.sort((a, b) =>
      a.Name < b.Name ? 1 : b.Name < a.Name ? -1 : 0
    );
    showprod(filterArr3);
  } else if (
    selectedfilter.value === "BestSelling" ||
...
var productdetailContainerClass = document.getElementsByClassName(
  "productdetailContainerClass"
);
...
var gohomebackfromProduct = document.getElementsByClassName(
  "gohomebackfromProduct"
);
